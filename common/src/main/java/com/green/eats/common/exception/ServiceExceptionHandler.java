...
@Slf4j
@RestControllerAdvice //빈등록 AOP
@ConditionalOnProperty(name = "constants.exception.common-handler.enabled", havingValue = "true") //gateway에는 RestControllerAdvice가 중복되서 두개로 안만들어지게끔 정의해준것.
